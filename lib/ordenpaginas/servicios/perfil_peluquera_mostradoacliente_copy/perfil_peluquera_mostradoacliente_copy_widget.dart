...
import 'perfil_peluquera_mostradoacliente_copy_model.dart';
export 'perfil_peluquera_mostradoacliente_copy_model.dart';

class PerfilPeluqueraMostradoaclienteCopyWidget extends StatefulWidget {
  const PerfilPeluqueraMostradoaclienteCopyWidget({super.key});

  @override
  State<PerfilPeluqueraMostradoaclienteCopyWidget> createState() =>
      _PerfilPeluqueraMostradoaclienteCopyWidgetState();
}

class _PerfilPeluqueraMostradoaclienteCopyWidgetState
    extends State<PerfilPeluqueraMostradoaclienteCopyWidget> {
  late PerfilPeluqueraMostradoaclienteCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model =
        createModel(context, () => PerfilPeluqueraMostradoaclienteCopyModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'PerfilPeluqueraMostradoaclienteCopy'});
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: InkWell(
          ...
          onTap: () async {
            logFirebaseEvent('PERFIL_PELUQUERA_MOSTRADOACLIENTE_COPY_I');
        ...
        actions: [
          FlutterFlowIconButton(
            ...
            onPressed: () async {
              logFirebaseEvent('PERFIL_PELUQUERA_MOSTRADOACLIENTE_COPY_a');
          ...
          children: [
            ...
            Align(
              ...
              child: Padding(
                ...
                child: Text(
                  FFLocalizations.of(context).getText(
                    'x8nglon7' /* Tengo amplia experiencia  en e... */,
                  ),
                        ...
                        children: [
                          TextSpan(
                            text: FFLocalizations.of(context).getText(
                              '4abgocg0' /* True Beauty (@true_beautyworld... */,
                            ),
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
                    ...
                    child: RichText(
                      ...
                      text: TextSpan(
                        children: [
                          TextSpan(
                            text: FFLocalizations.of(context).getText(
                              '657i1g3a' /* True Beauty (@true_beautyworld... */,
                            ),
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
            ...
            Align(
              ...
              child: Padding(
                ...
                child: Text(
                  FFLocalizations.of(context).getText(
                    'oimfy93a' /* Informacion adicional  */,
                  ),
                  style: FlutterFlowTheme.of(context).bodyMedium.override(
                        fontFamily:
                            FlutterFlowTheme.of(context).bodyMediumFamily,
            ...
            Padding(
              ...
              child: Text(
                FFLocalizations.of(context).getText(
                  'tuy8zi8f' /* Nacionalidad: Colombiana */,
                ),
                style: FlutterFlowTheme.of(context).bodyMedium.override(
