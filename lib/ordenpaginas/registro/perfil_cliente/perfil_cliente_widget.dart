...
class _PerfilClienteWidgetState extends State<PerfilClienteWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'PerfilCliente'});
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: FlutterFlowIconButton(
          ...
          onPressed: () async {
            logFirebaseEvent('PERFIL_CLIENTE_arrow_back_rounded_ICN_ON');
        ...
        title: Padding(
          ...
          child: Text(
            FFLocalizations.of(context).getText(
              'lgap3owk' /* Crea tu perfil de cliente */,
            ),
          ...
          children: [
            ...
            Align(
              ...
              child: Padding(
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    logFirebaseEvent('PERFIL_CLIENTE_PAGE_ENVIAR_BTN_ON_TAP');
            ...
            Align(
              ...
              child: FFButtonWidget(
                onPressed: () async {
                  logFirebaseEvent('PERFIL_CLIENTE_SIGN_IN_WITH_GOOGLE_BTN_O');
                  ...
                  context.goNamedAuth('PerfilCliente', context.mounted);
                },
                text: FFLocalizations.of(context).getText(
                  '20sss7js' /* Sign in with Google */,
                ),
                icon: const Icon(
                  Icons.add,
                  color: Colors.transparent,
                      ...
                      child: RichText(
                        ...
                        text: TextSpan(
                          children: [
                            TextSpan(
                              text: FFLocalizations.of(context).getText(
                                'oyovkd4e' /* Al tocar<< Enviar>> acepto los... */,
                              ),
                            ...
                            TextSpan(
                              text: FFLocalizations.of(context).getText(
                                'uiibcmv1' /* Terminos y condiciones */,
                              ),
                              style: TextStyle(
                                color: FlutterFlowTheme.of(context).primary,
                                fontSize: 13.0,
 ...
 así como reconozco y acept... */
                            ...
                            TextSpan(
                              text: FFLocalizations.of(context).getText(
                                'mt0js9p5' /* Política de privacidad */,
                              ),
