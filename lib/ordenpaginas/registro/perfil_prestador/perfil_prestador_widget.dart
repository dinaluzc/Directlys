...
import 'perfil_prestador_model.dart';
export 'perfil_prestador_model.dart';

class PerfilPrestadorWidget extends StatefulWidget {
  const PerfilPrestadorWidget({super.key});

  @override
  State<PerfilPrestadorWidget> createState() => _PerfilPrestadorWidgetState();
}

class _PerfilPrestadorWidgetState extends State<PerfilPrestadorWidget> {
  late PerfilPrestadorModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PerfilPrestadorModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'PerfilPrestador'});
      ...
      appBar: AppBar(
        ...
        actions: [
          FlutterFlowIconButton(
            ...
            onPressed: () async {
              logFirebaseEvent('PERFIL_PRESTADOR_arrow_back_rounded_ICN_');
          ...
          children: [
            ...
            Align(
              ...
              child: Padding(
                ...
                child: Text(
                  FFLocalizations.of(context).getText(
                    '47guuvsy' /* Tengo amplia experiencia  en e... */,
                  ),
                        ...
                        children: [
                          TextSpan(
                            text: FFLocalizations.of(context).getText(
                              'pupqwfdg' /* True Beauty (@true_beautyworld... */,
                            ),
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
                  ...
                  child: RichText(
                    ...
                    text: TextSpan(
                      children: [
                        TextSpan(
                          text: FFLocalizations.of(context).getText(
                            'or53i323' /* True Beauty (@true_beautyworld... */,
                          ),
                          style: FlutterFlowTheme.of(context)
                              .bodyMedium
                              .override(
            ...
            Align(
              ...
              child: Padding(
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    logFirebaseEvent('PERFIL_PRESTADOR_FINALIZAR_BTN_ON_TAP');
