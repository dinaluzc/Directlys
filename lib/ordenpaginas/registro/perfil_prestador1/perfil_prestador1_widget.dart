...
import 'perfil_prestador1_model.dart';
export 'perfil_prestador1_model.dart';

class PerfilPrestador1Widget extends StatefulWidget {
  const PerfilPrestador1Widget({super.key});

  @override
  State<PerfilPrestador1Widget> createState() => _PerfilPrestador1WidgetState();
}

class _PerfilPrestador1WidgetState extends State<PerfilPrestador1Widget> {
  late PerfilPrestador1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PerfilPrestador1Model());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'PerfilPrestador1'});
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: FlutterFlowIconButton(
          ...
          onPressed: () async {
            logFirebaseEvent('PERFIL_PRESTADOR1_arrow_back_rounded_ICN');
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: Image.network(
                'https://us.123rf.com/450wm/kritchanut/kritchanut1406/kritchanut140600066/29035228-hombre-silueta-avatar-icono-de-foto-de-perfil-en-c%C3%ADrculo-amarillo.jpg?ver=6',
                fit: BoxFit.cover,
              ),
            ),
            Align(
            ...
            Padding(
              ...
              child: TextFormField(
                ...
                decoration: InputDecoration(
                  labelText: FFLocalizations.of(context).getText(
                    '9xb8q162' /* Confirma tu correo electrónico */,
                  ),
                  labelStyle: FlutterFlowTheme.of(context).labelMedium.override(
                        fontFamily:
                            FlutterFlowTheme.of(context).labelMediumFamily,
            ...
            Align(
              ...
              child: Padding(
                ...
                child: FlutterFlowRadioButton(
                  options: [
                    FFLocalizations.of(context).getText(
                      'opbm8a03' /* Cédula de ciudadanía */,
                    ),
                    FFLocalizations.of(context).getText(
                      '6s4frvbc' /* Cédula de extrangería */,
                    )
                  ].toList(),
            ...
            Align(
              ...
              child: Padding(
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    logFirebaseEvent(
                        'PERFIL_PRESTADOR1_PAGE_ENVIAR_BTN_ON_TAP');
                    logFirebaseEvent('Button_navigate_to');

                    context.pushNamed('PerfilPrestadorInf');
                  },
                  text: FFLocalizations.of(context).getText(
                    'gn2ffzwj' /* Enviar */,
                  ),
                      ...
                      child: RichText(
                        ...
                        text: TextSpan(
                          children: [
                            TextSpan(
                              text: FFLocalizations.of(context).getText(
                                'alvoh2kr' /* Al tocar<< Enviar>> acepto los... */,
                              ),
                            ...
                            TextSpan(
                              text: FFLocalizations.of(context).getText(
                                'kevfs2sl' /* Terminos y condiciones */,
                              ),
                              style: TextStyle(
                                color: FlutterFlowTheme.of(context).primary,
                                fontSize: 13.0,
 ...
 así como reconozco y acept... */
                            ...
                            TextSpan(
                              text: FFLocalizations.of(context).getText(
                                '0g8nnkgu' /* Política de privacidad */,
                              ),
