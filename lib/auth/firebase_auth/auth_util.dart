...
DocumentReference? get currentUserReference =>
    loggedIn ? IndexappRecord.collection.doc(currentUser!.uid) : null;

IndexappRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : IndexappRecord.getDocument(IndexappRecord.collection.doc(uid))
              .handleError((_) {}),
    )
    .map((user) {
